...
import cn.fateverse.common.log.event.LoginInfoListener;
...
public class LogAutoConfiguration {
    ...
    @Bean
    public LoginInfoListener loginInfoListener(ThreadPoolTaskExecutor executor){
        return new LoginInfoListener(executor);
    }
